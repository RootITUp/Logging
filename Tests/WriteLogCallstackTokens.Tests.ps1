...
#
# Accordingly, these tests use Pester to create and run scripts that in turn call Write-Log, instead of calling
# Write-Log from directly within the tests. These tests will run relatively slowly as a result of this.
Describe 'CallerScope' {
    BeforeAll {
        ...
        $codeLineWaitLogging    = 'Wait-Logging'
